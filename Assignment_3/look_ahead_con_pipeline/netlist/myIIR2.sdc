...
# Created by write_sdc on Sat Nov 19 18:19:16 2022
...
create_clock [get_ports CLK]  -name MY_CLK  -period 2.8  -waveform {0 1.4}
...
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a3[13]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a3[12]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a3[11]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a3[10]}]
set_input_delay -clock MY_CLK  -max 0.5  [get_ports {a3[9]}]
