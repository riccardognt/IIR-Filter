...
#  Created on Sun Nov 20 16:57:52 2022                
#                                                     
#######################################################
...
set init_top_cell myIIR2
set init_verilog ../netlist/for_innovus/myIIR2_fm4.v
...
saveDesign myIIR2_fm4_innovus
saveDesign myIIR2_fm4_innovus
saveDesign myIIR2_fm4_innovus
reset_parasitics
extractRC
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix myIIR2_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix myIIR2_postRoute -outDir timingReports
...
set_verify_drc_mode -disable_rules {} -check_ndr_spacing auto -check_only default -check_same_via_cell false -exclude_pg_net false -ignore_trial_route false -ignore_cell_blockage false -use_min_spacing_on_block_obs auto -report myIIR2.drc.rpt -limit 1000
verify_drc
set_verify_drc_mode -area {0 0 0 0}
reportGateCount -level 5 -limit 100 -outfile myIIR2.gateCount
saveNetlist myIIR2_innovus.v
all_hold_analysis_views 
all_setup_analysis_views 
write_sdf  -ideal_clock_network myIIR2_innovus.sdf
write_sdf -ideal_clock_network -recompute_delay_calc myIIR2_innovus.sdf
